...
import iop.org.iop_contributors_app.CryptoUtil;
...
import iop.org.iop_contributors_app.utils.PrivateStorage;

/**
 * Created by mati on 09/11/16.
 * //todo: falta guardar la priv key del user y del cliente en un archivo encriptado..
 */
public class ProfileServerConfigurations extends Configurations {
    ...
    public ProfileServerConfigurations(Context context, SharedPreferences sharedPreferences) {
