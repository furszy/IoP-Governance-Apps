...
public class IntentsConstants {
    ...
    public static final String INTENT_BROADCAST_DATA_ON_COIN_RECEIVED_IS_TRANSACTION_MINE = BaseActivity.class.getPackage().toString()+"_bradcast_coin_received_is_transaction_mine";
