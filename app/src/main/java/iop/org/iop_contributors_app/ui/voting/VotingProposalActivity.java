        ...
        if (bundle.containsKey(INTENT_BROADCAST_DATA_VOTE_TRANSACTION_SUCCED)){
            ...
            switch (bundle.getInt(INTENTE_BROADCAST_DIALOG_TYPE,0)){
                case UNKNOWN_ERROR_DIALOG:
                    ...
                    if (bundle.containsKey(INTENT_EXTRA_MESSAGE_DIALOG)) {
                        textToShow = bundle.getString(INTENT_EXTRA_MESSAGE_DIALOG);
                    }
                ...
                case INVALID_PROPOSAL_DIALOG:
                    loadProposal();
                    SimpleDialogs.showErrorDialog(this,"Error",bundle.getString(INTENT_EXTRA_MESSAGE_DIALOG));
                    break;
