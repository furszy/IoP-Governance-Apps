...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final ApplicationController application) throws IOException
	{
		...
		report.append("Test/Prod: " + (WalletConstants.TEST ? "test" : "prod") + "\n");
		...
		calendar.setTimeInMillis(ApplicationController.TIME_CREATE_APPLICATION);
		...
		report.append("Network: " + WalletConstants.NETWORK_PARAMETERS.getId() + "\n");
		final Wallet wallet = application.getWalletModule().getWalletManager().getWallet();
