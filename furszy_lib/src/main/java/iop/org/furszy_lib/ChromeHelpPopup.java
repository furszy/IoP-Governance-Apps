...
public class ChromeHelpPopup {
    ...
    /** px que se mueve en el eje y ( es para desplazarlos y que no se pegué a la vista )*/
    private int yMove;
    ...
    public ChromeHelpPopup(Context context) {
        this(context, "", R.layout.popup_layout);
    ...
    public void show(View anchor) {
        ...
        if (anchorRect.left + rootWidth > screenWidth && false) {
            xPos = (screenWidth - rootWidth);
        }
        // ETXTREME LEFT CLIKED
        else if (anchorRect.left - (rootWidth / 2) < 0 && false) {
