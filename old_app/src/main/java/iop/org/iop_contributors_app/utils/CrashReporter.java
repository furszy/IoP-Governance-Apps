...
//	}
	...
	public static void appendApplicationInfo(final Appendable report, final AppController application) throws IOException {

		final PackageInfo pi = (PackageInfo) application.packageInfoWrapper().getPackageInfo();
		...
		final Wallet wallet = application.getModule().getWalletManager().getWallet();
